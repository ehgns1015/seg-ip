...
/**
 * InventoryForm component for creating or editing inventory items.
 *
 * @component
 * @param {InventoryFormProps} props - The component props
 * @returns {JSX.Element} The inventory form component
 */
const InventoryForm: React.FC<InventoryFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (mode === "create") {
        await inventoryApiService.createItem(trimmedData);
      } else if (mode === "edit" && initialData?.item) {
        await inventoryApiService.updateItem(initialData.item, trimmedData);
      }
